...
--- | --- | --- | ---
[grap_change_access](grap_change_access/) | 12.0.1.0.17 |  | Add new groups for specific models and change accesses for a number of models.
...
[mrp_food](mrp_food/) | 12.0.2.1.0 |  | MRP modules adapted for food-related professions
[mrp_sale_grouped](mrp_sale_grouped/) | 12.0.1.2.1 |  | Quickly manage what you need to produce thanks to grouped sales
