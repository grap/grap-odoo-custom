...
class ReportBomWizardProduction(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        (
            ...
            data_intermediate_product_bom_qty,
            data_matrix_boms,
        ...
        docargs = {
            ...
            "data_intermediate_product_bom_qty": data_intermediate_product_bom_qty,
    ...
    def create_datas_from_nested_boms(self, data_intermediate_product_list, wiz_line):
        ...
        for bom_line in wiz_line.bom_id.bom_line_ids.filtered(
            ...
            # Create this list used in PDF for printing Intermediate products BoMs
            data_intermediate_product_bom_qty.append(
