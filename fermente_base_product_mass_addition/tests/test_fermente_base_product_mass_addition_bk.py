...
class TestFermenteBaseProductMassAddition(TransactionCase):
    ...
    def test_01_mass_addition_purchase_bad(self):
        self.product_1._compute_mass_addition_purchase_bad()
        # import pdb; pdb.set_trace()
        self.assertEqual(self.product_1.mass_addition_purchase_min_qty_bad, False)
        self.assertEqual(
            self.product_1.mass_addition_purchase_multiplier_qty_bad, False
        )

    def test_02_mass_addition_purchase(self):
        self.product_1._compute_mass_addition_purchase()
        # import pdb; pdb.set_trace()
        self.assertEqual(self.product_1.mass_addition_purchase_min_qty, 0)
        self.assertEqual(self.product_1.mass_addition_purchase_multiplier_qty, 0)
        self.assertEqual(self.product_1.mass_addition_purchase_price, 10)
        self.assertEqual(self.product_1.mass_addition_purchase_discount, 0)
        self.assertEqual(self.product_1.mass_addition_purchase_discount2, 0)
